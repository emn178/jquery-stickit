...
this.stick!==e.None&&this.reset();this.locate()};c.prototype.destroy=function(){this.reset();this.spacer.remove();this.element.removeData("jquery-stickit")};c.prototype.enableWillChange=function(a){"auto"==this.origWillChange&&this.element.css("will-change",a?"transform":this.origWillChange)};var n,k,x=["destroy","refresh"];d.fn.stickit=function(a,b){if("string"==typeof a){if(-1!=d.inArray(a,x)){var e=arguments;this.each(function(){var b=d(this).data("jquery-stickit");b&&b[a].apply(b,Array.prototype.slice.call(e,
1))})}}else t||(t=!0,m(),d(document).ready(function(){d(window).bind("resize",m).bind("scroll",p);d(document.body).bind("animationend webkitAnimationEnd oAnimationEnd transitionend webkitTransitionEnd oTransitionEnd",p);d(document).bind("webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange",u)}),w&&(new MutationObserver(v)).observe(document,{attributes:!0,childList:!0,characterData:!0,subtree:!0})),b=d.isArray(a)?a:Array.prototype.slice.call(arguments,0),this.each(function(){var a=
new c(this,b);d(this).data("jquery-stickit",a);a.locate()});return this};d.stickit={refresh:l}})(jQuery);
